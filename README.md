...
- ***How this has been achieved:*** 
    ...
    ![Screenshot of navbar](assets/img/sc-navbar.png)
    ...
    ![Screenshot of Hero section](assets/img/sc-hero.png)
    - The *Treatments & Prices* section details the different treatments available, which includes a brief description, a price list, and an accompanying image.
    ![Screenshot of Treatments & Prices section](assets/img/sc-treatments.png)
    - The *Reasons to Choose Us* section details the various reasons to choose the company over its competitors.
    ![Screenshot of Reasons to Choose Us section](assets/img/sc-reasons.png)
    - The *Reviews* section displays positive feedback from previous customers.
    ![Screenshot of Customer Reviews section](assets/img/sc-reviews.png)
    - The *Get in Touch* section includes a simple contact form that allows users to send a message to the company. On submission, the user receives an immediate notification that someone will contact them as soon as possible.
    ![Screenshot of contact form](assets/img/sc-contact-form.png)
    ...
    ![Screenshot of Get in Touch section](assets/img/sc-contact.png)
    ...
    ![Screenshot of Footer section](assets/img/sc-footer.png)
